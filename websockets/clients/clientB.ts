...
ws.onclose = (closeEv) => {
    ...
    ws.send('{ "message" : "(B) i\'m outta here !" }');
}

while (true) {
    const buf = new Uint8Array(100);
    const PS1 = new TextEncoder().encode("[client b] Ctrl + C to exit $ "); 
